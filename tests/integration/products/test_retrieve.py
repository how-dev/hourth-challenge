...
class TestRetrieveProducts:
    def test_retrieve_failed_because_is_unauthenticated(self, api_client):
        payload = {"path": "/api/v1/products/0/"}
    ...
    def test_retrieve_success(self, base_product, super_user_logged):
        ...
        payload = {"path": f"/api/v1/products/{base_product.id}/"}
    ...
    def test_retrieve_success_with_consult_date(self, base_product, super_user_logged):
        sale = SalesFactory(products=base_product)
        SalesFactory.create_batch(3, products=base_product)
        ...
        payload = {
            "path": f"/api/v1/products/{base_product.id}/?consult_date={consult_date}"
        }
